...
object DocsRegistry {
  val screenshots = listOf(
    ...
    ComposeScreenshot("Calendar 2 - Compose - Pre-selected range", "range"),
    ComposeScreenshot("Calendar 2 - Compose - Day colours", "colored"),
    ComposeScreenshot("Calendar 2 - Compose - Day labels", "labeled"),
    ComposeScreenshot("Calendar 2 - Compose - Selection Whole Month", "month"),
