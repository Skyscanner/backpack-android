...
object DocsRegistry {
  val screenshots = listOf(
    ...
    ViewScreenshot("Button - View - Primary", "primary"),
    ViewScreenshot("Button - View - Secondary", "secondary"),
    ViewScreenshot("Button - View - Featured", "featured"),
    ViewScreenshot("Button - View - Destructive", "destructive"),
    ViewScreenshot("Button - View - Primary on dark", "primary_on_dark"),
    ViewScreenshot("Button - View - Primary on light", "primary_on_light"),
