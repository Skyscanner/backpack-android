...
class ScreenshotTestsServer @JvmOverloads constructor(
  ...
  private fun app(request: Request): Response =
    try {
      ...
      // 10ms delay to make sure the buttons are unpressed and states is updated
      Thread.sleep(10L)
  ...
  private fun Dadb.setup() {
    ...
    Thread.sleep(100L) // sleeping for 100 msec to make sure these settings actually applied
  }
