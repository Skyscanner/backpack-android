...
internal fun BpkCalendarSpaceCell(
  ...
  Spacer(
    modifier = modifier.applyIf(model.selected) {
      background(
        brush = CalendarDayBackground.selectionTopBrush(CalendarCell.Selection.Middle),
        shape = CalendarDayBackground.selectionTopShape(CalendarCell.Selection.Middle),
      )
    }
  )
}
