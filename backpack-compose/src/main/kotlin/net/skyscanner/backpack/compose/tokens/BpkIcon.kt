...
public val BpkIcon.Companion.values: List<BpkIcon> by Delegates.singleton(
    listOf(
        BpkIcon.Accessibility, BpkIcon.Account, BpkIcon.AccountAdd, BpkIcon.AccountCircle,
                ...
                BpkIcon.DocumentCsv, BpkIcon.DocumentPdf, BpkIcon.Download, BpkIcon.Duration,
                BpkIcon.EcoLeaf, BpkIcon.Edit, BpkIcon.Education, BpkIcon.Electric, BpkIcon.EndCall,
                BpkIcon.Estimated, BpkIcon.Exclamation, BpkIcon.ExclamationCircle, BpkIcon.Expand,
                BpkIcon.Explore, BpkIcon.FaceBlank, BpkIcon.FaceHappy, BpkIcon.FaceId,
                BpkIcon.FaceMask, BpkIcon.FaceSad, BpkIcon.Family, BpkIcon.FastTrack,
                BpkIcon.FastTrain, BpkIcon.Filter, BpkIcon.Fingerprint, BpkIcon.Flag, BpkIcon.Flask,
                BpkIcon.Flight, BpkIcon.FlightFlexible, BpkIcon.FlightLanding,
                BpkIcon.FlightTakeoff, BpkIcon.Food, BpkIcon.GearsAutomatic,
                BpkIcon.GearsAutomaticCircle, BpkIcon.GearsManual, BpkIcon.GearsManualCircle,
                BpkIcon.Globe, BpkIcon.GridLayout, BpkIcon.Headset, BpkIcon.HealthFitness,
                BpkIcon.Heart, BpkIcon.HeartOutline, BpkIcon.Help, BpkIcon.HelpCircle, BpkIcon.Hide,
                BpkIcon.HotelFlexible, BpkIcon.Hotels, BpkIcon.HotelsDisabledFacilities,
                BpkIcon.HotelsJacuzzi, BpkIcon.HotelsPetsAllowed, BpkIcon.HotelsSmoking,
                BpkIcon.Infant, BpkIcon.Information, BpkIcon.InformationCircle,
                BpkIcon.InformationLanguage, BpkIcon.InformationLanguageAlert,
                BpkIcon.InformationLanguageQuestion, BpkIcon.Insurance, BpkIcon.Key, BpkIcon.Keypad,
                BpkIcon.Landmark, BpkIcon.Language, BpkIcon.LegroomExtra, BpkIcon.LegroomNormal,
                BpkIcon.LegroomReduced, BpkIcon.Leisure, BpkIcon.Lightning, BpkIcon.List,
                BpkIcon.Location, BpkIcon.Lock, BpkIcon.Logout, BpkIcon.LongArrowDown,
                BpkIcon.LongArrowLeft, BpkIcon.LongArrowRight, BpkIcon.LongArrowUp, BpkIcon.Lounge,
                BpkIcon.Luggageall, BpkIcon.Mail, BpkIcon.Map, BpkIcon.Meal, BpkIcon.Media,
                BpkIcon.Menu, BpkIcon.MenuHorizontal, BpkIcon.MenuVertical, BpkIcon.Mileage,
                BpkIcon.Minus, BpkIcon.Mobile, BpkIcon.Money, BpkIcon.MultipleBookings,
                BpkIcon.Music, BpkIcon.Mute, BpkIcon.NativeAndroidBack, BpkIcon.NativeAndroidClose,
