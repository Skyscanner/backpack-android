...
public val BpkIcon.Companion.values: List<BpkIcon> by Delegates.singleton(
  listOf(
    BpkIcon.Accessibility, BpkIcon.Account, BpkIcon.AccountAdd, BpkIcon.AccountCircle,
        BpkIcon.AccountFemale, BpkIcon.AccountIdCard, BpkIcon.AccountName, BpkIcon.AccountPermit,
        BpkIcon.AddCircle, BpkIcon.Adult, BpkIcon.Aircon, BpkIcon.Aircraft, BpkIcon.Airline,
        ...
        BpkIcon.FaceBlank, BpkIcon.FaceHappy, BpkIcon.FaceId, BpkIcon.FaceMask, BpkIcon.FaceSad,
        BpkIcon.Family, BpkIcon.FastTrack, BpkIcon.FastTrain, BpkIcon.Filter, BpkIcon.Fingerprint,
        BpkIcon.Flag, BpkIcon.Flask, BpkIcon.Flight, BpkIcon.FlightFlexible, BpkIcon.FlightLanding,
        BpkIcon.FlightTakeoff, BpkIcon.Food, BpkIcon.GearsAutomatic, BpkIcon.GearsAutomaticCircle,
        BpkIcon.GearsManual, BpkIcon.GearsManualCircle, BpkIcon.Globe, BpkIcon.GridLayout,
        BpkIcon.Headset, BpkIcon.HealthFitness, BpkIcon.Heart, BpkIcon.HeartOutline, BpkIcon.Help,
        ...
        BpkIcon.HotelsSmoking, BpkIcon.Infant, BpkIcon.Information, BpkIcon.InformationCircle,
        ...
        BpkIcon.LegroomReduced, BpkIcon.Leisure, BpkIcon.Lightning, BpkIcon.List, BpkIcon.Location,
        BpkIcon.Lock, BpkIcon.Logout, BpkIcon.LongArrowDown, BpkIcon.LongArrowLeft,
