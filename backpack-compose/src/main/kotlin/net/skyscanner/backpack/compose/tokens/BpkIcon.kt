...
public val BpkIcon.Companion.Dot: BpkIcon by Delegates.singleton(
    BpkIcon(
        name = "dot",
        small = R.drawable.bpk_dot_sm,
        large = R.drawable.bpk_dot,
    )
)
...
public val BpkIcon.Companion.values: List<BpkIcon> by Delegates.singleton(
    listOf(
        BpkIcon.Accessibility, BpkIcon.Account, BpkIcon.AccountAdd, BpkIcon.AccountCircle,
                ...
                BpkIcon.Award, BpkIcon.BabyCarriage, BpkIcon.Baggage, BpkIcon.BaggageAdd,
                BpkIcon.BaggageCabin, BpkIcon.BaggageCabinAdd, BpkIcon.BaggageCabinNotIncluded,
                BpkIcon.BaggageChecked, BpkIcon.BaggageCheckedAdd,
                BpkIcon.BaggageCheckedNotIncluded, BpkIcon.BaggageCross, BpkIcon.BaggageGeneric,
                BpkIcon.BaggageRemove, BpkIcon.BaggageTick, BpkIcon.Bar, BpkIcon.Beach,
                BpkIcon.Beer, BpkIcon.BreakfastCross, BpkIcon.BreakfastTick, BpkIcon.Bus,
                BpkIcon.Business, BpkIcon.Cafe, BpkIcon.Calendar, BpkIcon.CallBack, BpkIcon.Camera,
                BpkIcon.CamperVan, BpkIcon.CarDoor, BpkIcon.CarWash, BpkIcon.Cars,
                ...
                BpkIcon.ContentGuides, BpkIcon.Currency, BpkIcon.Data, BpkIcon.Deals,
                BpkIcon.Depart, BpkIcon.DeviceMid, BpkIcon.DeviceWide, BpkIcon.Direct,
                BpkIcon.DocumentCsv, BpkIcon.DocumentPdf, BpkIcon.Dot, BpkIcon.Download,
                BpkIcon.Duration, BpkIcon.EcoLeaf, BpkIcon.Edit, BpkIcon.Education,
                BpkIcon.Electric, BpkIcon.EndCall, BpkIcon.Estimated, BpkIcon.Exclamation,
                BpkIcon.ExclamationCircle, BpkIcon.Expand, BpkIcon.Explore, BpkIcon.FaceBlank,
                BpkIcon.FaceHappy, BpkIcon.FaceId, BpkIcon.FaceMask, BpkIcon.FaceSad,
                BpkIcon.Family, BpkIcon.FastTrack, BpkIcon.FastTrain, BpkIcon.Filter,
                BpkIcon.Fingerprint, BpkIcon.Flag, BpkIcon.Flask, BpkIcon.Flight,
                BpkIcon.FlightFlexible, BpkIcon.FlightLanding, BpkIcon.FlightTakeoff, BpkIcon.Food,
                BpkIcon.GearsAutomatic, BpkIcon.GearsAutomaticCircle, BpkIcon.GearsManual,
                BpkIcon.GearsManualCircle, BpkIcon.Globe, BpkIcon.GridLayout, BpkIcon.Headset,
                BpkIcon.HealthFitness, BpkIcon.Heart, BpkIcon.HeartOutline, BpkIcon.Help,
                BpkIcon.HelpCircle, BpkIcon.Hide, BpkIcon.HotelFlexible, BpkIcon.Hotels,
                BpkIcon.HotelsDisabledFacilities, BpkIcon.HotelsJacuzzi, BpkIcon.HotelsPetsAllowed,
                BpkIcon.HotelsSmoking, BpkIcon.Infant, BpkIcon.Information,
                BpkIcon.InformationCircle, BpkIcon.InformationLanguage,
                BpkIcon.InformationLanguageAlert, BpkIcon.InformationLanguageQuestion,
                BpkIcon.Insurance, BpkIcon.Key, BpkIcon.Keypad, BpkIcon.Landmark, BpkIcon.Language,
                BpkIcon.LegroomExtra, BpkIcon.LegroomNormal, BpkIcon.LegroomReduced,
                BpkIcon.Leisure, BpkIcon.Lightning, BpkIcon.List, BpkIcon.Location, BpkIcon.Lock,
                BpkIcon.Logout, BpkIcon.LongArrowDown, BpkIcon.LongArrowLeft,
                BpkIcon.LongArrowRight, BpkIcon.LongArrowUp, BpkIcon.Lounge, BpkIcon.Luggageall,
                BpkIcon.Mail, BpkIcon.Map, BpkIcon.Meal, BpkIcon.Media, BpkIcon.Menu,
                BpkIcon.MenuHorizontal, BpkIcon.MenuVertical, BpkIcon.Mileage, BpkIcon.Minus,
                BpkIcon.Mobile, BpkIcon.Money, BpkIcon.MultipleBookings, BpkIcon.Music,
                BpkIcon.Mute, BpkIcon.NativeAndroidBack, BpkIcon.NativeAndroidClose,
                BpkIcon.NativeAndroidForward, BpkIcon.NativeIosClose, BpkIcon.Navigation,
                BpkIcon.NewWindow, BpkIcon.News, BpkIcon.Night, BpkIcon.NotAllowed, BpkIcon.Onsen,
                BpkIcon.Origin, BpkIcon.Paid, BpkIcon.Paperclip, BpkIcon.Parking, BpkIcon.Passport,
                BpkIcon.Pause, BpkIcon.PaymentCard, BpkIcon.Petrol, BpkIcon.PhoneCall,
                BpkIcon.Picture, BpkIcon.Pin, BpkIcon.PlaneSeat, BpkIcon.Play, BpkIcon.Plus,
                BpkIcon.Policy, BpkIcon.Powerplug, BpkIcon.Ppe, BpkIcon.PriceAlerts,
                BpkIcon.PriceTag, BpkIcon.Print, BpkIcon.RecentSearches, BpkIcon.Redo,
                BpkIcon.Refresh, BpkIcon.Return, BpkIcon.Room, BpkIcon.Scales, BpkIcon.Search,
                BpkIcon.SelfService, BpkIcon.SendMessage, BpkIcon.Services, BpkIcon.Settings,
                BpkIcon.Share, BpkIcon.ShareAndroid, BpkIcon.ShareIos, BpkIcon.SingleBooking,
                BpkIcon.SocialDistancing, BpkIcon.SocialLike, BpkIcon.Sort, BpkIcon.SortDown,
                BpkIcon.SortUp, BpkIcon.Speaker, BpkIcon.Star, BpkIcon.StarHalf,
                BpkIcon.StarOutline, BpkIcon.Stops, BpkIcon.Swap, BpkIcon.SwapHorizontal,
                BpkIcon.SwapVertical, BpkIcon.Taxi, BpkIcon.ThumbsDown, BpkIcon.ThumbsUp,
                BpkIcon.Tick, BpkIcon.TickCircle, BpkIcon.Ticket, BpkIcon.TicketFlexible,
