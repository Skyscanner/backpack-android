...
import net.skyscanner.backpack.compose.map.internal.BpkPriceMapMarkerImpl
import net.skyscanner.backpack.compose.map.internal.PriceMarkerLayoutImpl
...
fun PriceMarkerLayout(title: String, status: BpkPriceMarkerStatus, modifier: Modifier = Modifier) {
    PriceMarkerLayoutImpl(title = title, status = status, modifier = modifier)
}
