...
import net.skyscanner.backpack.compose.map.internal.BpkHotelMapMarkerImpl
import net.skyscanner.backpack.compose.map.internal.HotelMarkerLayoutImpl

enum class BpkHotelMarkerStatus {
    Unselected,
    Selected,
}
...
fun BpkHotelMapMarker(
    ...
    icon: BpkIcon,
    status: BpkHotelMarkerStatus = BpkHotelMarkerStatus.Unselected,
...
fun HotelMarkerLayout(status: BpkHotelMarkerStatus, icon: BpkIcon, modifier: Modifier = Modifier) {
    HotelMarkerLayoutImpl(status = status, icon = icon, modifier = modifier)
}
