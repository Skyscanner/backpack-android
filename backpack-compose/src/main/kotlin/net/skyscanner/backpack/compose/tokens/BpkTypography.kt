...
public data class BpkTypography internal constructor(
    ...
    public companion object {
        ...
        public fun VDL2(defaultFontFamily: FontFamily = FontFamily.SansSerif): BpkTypography = BpkTypography(
            ...
            // Hero 5 - Amended - Black font weight, -1.2px letter spacing
            hero5 = TextStyle(
                fontWeight = FontWeight.Black,
                fontSize = BpkFontSize.Xxxxl,
                lineHeight = BpkLineHeight.Xxxxl,
            ...
            // Heading 1 - Amended - Black font weight, -1.2px letter spacing
            heading1 = TextStyle(
                fontWeight = FontWeight.Black,
                fontSize = BpkFontSize.Xxxl,
                lineHeight = BpkLineHeight.Xxxl,
            ...
            // Heading 2 - Amended - Black font weight, -1.0px letter spacing
            heading2 = TextStyle(
                fontWeight = FontWeight.Black,
                fontSize = BpkFontSize.Xxl,
                lineHeight = BpkLineHeight.Xxl,
            ...
            // Heading 3 - Amended - Black font weight, -0.6px letter spacing
            heading3 = TextStyle(
                fontWeight = FontWeight.Black,
                fontSize = BpkFontSize.Xl,
                lineHeight = BpkLineHeight.XlTight,
            ...
            // Heading 4 - Amended - Black font weight, -0.6px letter spacing
            heading4 = TextStyle(
                fontWeight = FontWeight.Black,
                fontSize = BpkFontSize.Lg,
                lineHeight = BpkLineHeight.LgTight,
            ...
            // Heading 5 - Amended - Black font weight, -0.6px letter spacing
            heading5 = TextStyle(
                fontWeight = FontWeight.Black,
                fontSize = BpkFontSize.Base,
                lineHeight = BpkLineHeight.BaseTight,
