...
import net.skyscanner.backpack.compose.imagegallery.internal.BpkImageGalleryPreviewDefaultImpl
import net.skyscanner.backpack.compose.imagegallery.internal.BpkImageGalleryPreviewHeroImpl
...
fun BpkImageGalleryPreviewDefault(
    ...
    BpkImageGalleryPreviewDefaultImpl(
        image = image,
...
fun BpkImageGalleryPreviewHero(
    ...
    BpkImageGalleryPreviewHeroImpl(
        state = state,
        modifier = modifier,
