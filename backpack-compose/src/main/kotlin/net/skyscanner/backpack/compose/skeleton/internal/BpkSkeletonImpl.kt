...
package net.skyscanner.backpack.compose.skeleton.internal
...
import androidx.compose.ui.unit.dp
import net.skyscanner.backpack.compose.skeleton.BpkCircleSizeType
import net.skyscanner.backpack.compose.skeleton.BpkShimmerSize
import net.skyscanner.backpack.compose.skeleton.BpkSkeletonCornerType
...
@Composable
internal fun BpkShimmerOverlayImpl(
    modifier: Modifier = Modifier,
...
@Composable
internal fun BpkImageSkeletonImpl(
    modifier: Modifier = Modifier,
...
@Composable
internal fun BpkBodyTextSkeletonImpl(
    modifier: Modifier = Modifier,
) {
...
@Composable
internal fun BpkHeadlineSkeletonImpl(
    modifier: Modifier = Modifier,
...
@Composable
internal fun BpkCircleSkeletonImpl(
