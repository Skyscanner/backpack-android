...
| Day                                                                                                                                                                                                     | Night                                                                                                                                                                                                                    |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <img src="https://raw.githubusercontent.com/Skyscanner/backpack-android/main/docs/compose/SearchInputSummary/screenshots/read-only.png" alt="BpkSearchInputSummary component in read only mode" width="375" /> | <img src="https://raw.githubusercontent.com/Skyscanner/backpack-android/main/docs/compose/SearchInputSummary/screenshots/read-only_dm.png" alt="BpkSearchInputSummary component in read only mode - dark mode" width="375" /> |
...
`BpkSearchInputSummary` is a specialised text field with larger corners and support for a prefix (`None`, `Text`, or `Icon`). It supports read-only mode and an optional clear action.
...
Example of a `BpkSearchInputSummary` showing an icon prefix:
...
Example of a `BpkSearchInputSummary` in read-only focused mode:
