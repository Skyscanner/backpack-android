...
class BpkOutlineChip @JvmOverloads constructor(
  ...
  override fun provideAppearance(context: Context, attrs: AttributeSet?, defStyleAttr: Int): BpkChipAppearance =
    BpkChipAppearances.Stroke(context, attrs, defStyleAttr)
}
