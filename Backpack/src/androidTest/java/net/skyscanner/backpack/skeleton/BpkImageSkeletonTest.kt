...
class BpkImageSkeletonTest {

  @Test
  @UiThreadTest
  fun test_clipToOutlineForDefault() {
    val context = InstrumentationRegistry.getInstrumentation().targetContext
    val skeleton = BpkImageSkeleton(context)
    Assert.assertEquals(false, skeleton.clipToOutline)
  ...
  @Test
  @UiThreadTest
  fun test_clipToOutlineForRoundedCorner() {
    val context = InstrumentationRegistry.getInstrumentation().targetContext
    val skeleton = BpkImageSkeleton(context)
