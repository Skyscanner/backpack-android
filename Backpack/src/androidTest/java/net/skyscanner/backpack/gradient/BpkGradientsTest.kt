...
class BpkGradientsTest {
  ...
  fun getPrimary() {
    ...
    val expectedGradient = GradientDrawable(
      ...
      intArrayOf(
        testContext.getColor(R.color.bpkSkyBlue),
        testContext.getColor(R.color.bpkSkyBlue),
      )
    )
    ...
    assertEquals(testContext.getColor(R.color.bpkSkyBlue), gradient.colors?.get(0))
    assertEquals(testContext.getColor(R.color.bpkSkyBlue), gradient.colors?.get(1))
  }
