...
class BackpackPublishingPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        with(target) {
            plugins.apply("maven-publish")

            val publishingExt = extensions.create("backpackPublishing", BackpackPublishingExtension::class.java)
            ...
            afterEvaluate {
                extensions.configure<PublishingExtension> {
                    repositories {
                        maven {
                            name = "GitHubPackages"
                            setUrl("https://maven.pkg.github.com/skyscanner/backpack-android")
                            credentials {
